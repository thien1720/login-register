...
function Login(pops) {
    ...
    return <div className={cx("box-login")}>
        <div className={cx("sub-form")}>
            <div className={cx("form-reg")}>
                ...
                <div className={cx("title-form")}>
                    <h1>Đăng Nhập</h1>
                    <span>Sử dụng Tài khoản Google của bạn</span>
                </div>
                            ...
                            <div className={cx("layout-input")}>
                                <div className={cx("in-email")}>
                                    <div className={cx("box-email")}>
                                        <div className={cx("input-contain")}>
                                            ...
                                            <label className={cx("placeholder-text")} for="email" id="placeholder-lname">
                                                <div className={cx("text-name")}>Email hoặc số điện thoại</div>
                                            </label>
                                    ...
                                    <div className={cx("user-email-me")}>
                                        <button>
                                            <span>Bạn quyên địa chỉ email?</span>

                                        </button>
                                        <div className={cx("find-out-more")}>
                                            <p>
                                                Đây không phải máy tính của bạn?
                                                Hãy sử dụng chế độ Khách để đăng nhập một cách riêng tư.
                                                <b>Tìm hiểu thêm</b>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className={cx("btn-login-next")}>
                                    <div className={cx("box-option-create" ,"un-active")}>
                                        <ul>
                                            <li>
                                                <a>Dành cho mục đích cá nhân của tôi.</a>
                                            </li>
                                            <li>
                                                <a>Cho con tôi.</a>
                                            </li>
                                            <li>
                                                <a>Dành cho công việc hoặc doanh nghiệp của tôi</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class={cx("option-create")}>
                                        <div className={cx("box-btn-login", "create-use")}>
