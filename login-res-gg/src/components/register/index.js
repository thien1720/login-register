...
function Register(pops) {

    return <div className={cx("box-register")}>
        <div className={cx("sub-form")}>
            <div className={cx("form-reg")}>
                <div>
                    ...
                    <div className={cx("content-form")}>
                        <form>
                            <div className={cx("layout-input")}>
                                <div className={cx("in-name")}>
                                    <div className={cx("input-contain", "first-name")}>
                                        <input className={cx("form-in")} type="text" id="fname" name="fname" aria-labelledby="placeholder-fname" />
                                        <label className={cx("placeholder-text")} for="fname" id="placeholder-fname">
                                            <div className={cx("text-name")}>Họ</div>
                                        </label>
                                    </div>
                                    <div className={cx("input-contain")}>
                                        <input className={cx("form-in")} type="text" id="fname" name="fname" aria-labelledby="placeholder-fname" />
                                        <label className={cx("placeholder-text")} for="fname" id="placeholder-lname">
                                            <div className={cx("text-name")}>Tên</div>
                                        </label>
                                    </div>

                                </div>

                                <div className={cx("in-email")}>
                                    <div className={cx("box-email")}>
                                        <div className={cx("input-contain")}>
                                            <input className={cx("form-in")} type="text" id="email" name="fname" aria-labelledby="placeholder-fname" />
                                            <label className={cx("placeholder-text")} for="email" id="placeholder-lname">
                                                <div className={cx("text-name")}>Tên người dùng</div>
                                            </label>

                                            <div className={cx("last-email")}>
                                                <span>@gmail.com</span>
                                            </div>
                                        </div>
                                        <div className={cx("sub-email")}>
                                            Bạn có thể sử dụng chữ cái, số và dấu chấm
                                        </div>
                                    </div>

                                    <div className={cx("user-email-me")}>
                                        <button className={cx("btn-email")}>
                                            <span>Sử dụng địa chỉ email hiện tại của tôi</span>
                                        </button>
                                    </div>
                                </div>

                                <div>
                                    <div className={cx("in-password")}>
                                        <div className={cx("input-contain", "first-name")}>
                                            <input className={cx("form-in")} type="text" id="pass" name="pass" aria-labelledby="placeholder-pass" />
                                            <label className={cx("placeholder-text")} for="pass" id="placeholder-pass">
                                                <div className={cx("text-name")}>Mật Khẩu</div>
                                            </label>
                                        </div>
                                        <div className={cx("input-contain")}>
                                            <input className={cx("form-in")} type="text" id="confirm" name="confirm" aria-labelledby="placeholder-confirm" />
                                            <label className={cx("placeholder-text")} for="confirm" id="placeholder-lname">
                                                <div className={cx("text-name")}>Xác Nhận</div>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div className={cx("show-pass")}>
                                        ...
                                        <label for="show" className={cx("showlabel")}>
                                            Hiện Mật Khẩu
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className={cx("btn-login-next")}>
                                    <div className={cx("box-btn-login")}>
                                        <button className={cx("btn-login")}>
                                            <span>Đăng Nhập</span>
                                        </button>
                                    </div>

                                    <div className={cx("box-btn-next")}>
            ...
            <div className={cx("protext-account")}>
                <div className={cx("img-pro")}>
                    <img src="/images/account.svg" alt="account" />
                </div>
                <div className={cx("sub-account")}>
                    <figcaption >
                        Một tài khoản. Hoạt động trên mọi sản phẩm và dịch vụ của Google.
                    </figcaption>
                </div>
        ...
        <footer className={cx("footer")} >
            <div className={cx("list-language" , "un-active")}>
                <ul>
